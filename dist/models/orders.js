...
var OrderStore = /** @class */ (function () {
    ...
    OrderStore.prototype.userOrders = function (id, status) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [id, status])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO orders (product_id, quantity, user_id, status) VALUES($1, $2, $3, $4)";
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add new Order ".concat(b.product_id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.dropOrderRecords = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not delete all records from orders table. Error: ".concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
